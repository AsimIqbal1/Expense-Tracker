...
const WalletsOverview = (_props: IWalletsOverviewProps) => {
    ...
    return (
        <Flex my={theme.space.x2} p={`${theme.space.x4} ${theme.space.x6}`} border={`1px solid ${theme.colors.border[colorMode]}`} borderRadius={theme.borderRadius.md} justifyContent={"space-between"} alignItems={'center'} flexWrap="wrap">
            <Box>
